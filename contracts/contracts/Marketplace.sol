...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC165Upgradeable.sol@v4.5.1
...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC2981Upgradeable.sol@v4.5.1
...
// File @openzeppelin/contracts-upgradeable/utils/MulticallUpgradeable.sol@v4.5.1
...
interface IMarketplace is IThirdwebContract, IPlatformFee {
    ...
    **/
    ...
    event ListingUpdated(uint256 indexed listingId, Listing listing, address indexed listingCreator);

    /// @dev Emitted when a listing is cancelled.
    event ListingRemoved(uint256 indexed listingId, Listing listing, address indexed listingCreator);
    ...
    IERC1155ReceiverUpgradeable
{
    ...
    function updateListing(
        ...
        emit ListingUpdated(_listingId, targetListing, targetListing.tokenOwner);
    }
    ...
    function cancelDirectListing(uint256 _listingId) external onlyListingCreator(_listingId) {
        ...
        emit ListingRemoved(_listingId, targetListing, targetListing.tokenOwner);
    }

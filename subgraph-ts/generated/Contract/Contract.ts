...
export class ListingRemoved__Params {
  ...
  get listing(): ListingRemovedListingStruct {
    return changetype<ListingRemovedListingStruct>(
...
export class ListingRemovedListingStruct extends ethereum.Tuple {
  get listingId(): BigInt {
    return this[0].toBigInt();
  }
...
export class ListingUpdated__Params {
  ...
  get listing(): ListingUpdatedListingStruct {
    return changetype<ListingUpdatedListingStruct>(
      this._event.parameters[1].value.toTuple()
    );
  }
...
export class ListingUpdatedListingStruct extends ethereum.Tuple {
  get listingId(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__getPlatformFeeInfoResult {
  value0: Address;
  value1: i32;
...
export class Contract__winningBidResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class Contract extends ethereum.SmartContract {
  ...
  getPlatformFeeInfo(): Contract__getPlatformFeeInfoResult {
    let result = super.call(
      "getPlatformFeeInfo",
    ...
    return new Contract__getPlatformFeeInfoResult(
      result[0].toAddress(),
      result[1].toI32()
    );
  }
  ...
  try_getPlatformFeeInfo(): ethereum.CallResult<
    Contract__getPlatformFeeInfoResult
  > {
    let result = super.tryCall(
      "getPlatformFeeInfo",
      "getPlatformFeeInfo():(address,uint16)",
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getPlatformFeeInfoResult(
        value[0].toAddress(),
        value[1].toI32()
      )
    );
  ...
  listings(param0: BigInt): Contract__listingsResult {
    let result = super.call(
      "listings",
  ...
  try_listings(param0: BigInt): ethereum.CallResult<Contract__listingsResult> {
    let result = super.tryCall(
      "listings",
      "listings(uint256):(uint256,address,address,uint256,uint256,uint256,uint256,address,uint256,uint256,uint8,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  offers(param0: BigInt, param1: Address): Contract__offersResult {
    let result = super.call(
      "offers",
  ...
  winningBid(param0: BigInt): Contract__winningBidResult {
    let result = super.call(
      "winningBid",
    ...
    return new Contract__winningBidResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_winningBid(
    param0: BigInt
  ): ethereum.CallResult<Contract__winningBidResult> {
    let result = super.tryCall(
      "winningBid",
      "winningBid(uint256):(uint256,address,uint256,address,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__winningBidResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
